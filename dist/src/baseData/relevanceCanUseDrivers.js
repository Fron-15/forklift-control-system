(function() {
    define(['app'], function(app) {
        app.controller('relevanceCanUseDriversCtrl', relevanceCanUseDriversCtrl);

        relevanceCanUseDriversCtrl.$inject = ['$scope', 'Service',
        '$uibModalInstance','swal'];

        function relevanceCanUseDriversCtrl($scope, Service,$uibModalInstance,swal) {
            ...
            function getTableData() {
                var name = 'relevanceCanUseDrivers'+vm.condition.pageNo;
