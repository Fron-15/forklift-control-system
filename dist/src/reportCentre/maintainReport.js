(function() {
    define(['app'], function(app) {
        ...
        maintainReportCtrl.$inject = ['$scope', 'DatePicker', 'Service', '$state'];

        function maintainReportCtrl($scope, DatePicker, Service, $state) {
            var vm = this;
            var vm = this;
            //全选属性
            vm.allChecked = false;
            ...
            //打开月统计图表
            vm.openmaintainReportCharts = openmaintainReportCharts;
            //查询条件
            ...
            //打开叉车工作时间统计图表
            function openmaintainReportCharts() {
                $state.go('module', { parent: 'reportCharts', name: 'maintainReportCharts', param: null });
