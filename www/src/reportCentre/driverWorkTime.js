(function() {
    define(['app'], function(app) {
        ...
        driverWorkTimeCtrl.$inject = ['$scope', 'DatePicker', 'Service','$state'];

        function driverWorkTimeCtrl($scope, DatePicker, Service,$state) {
            var vm = this;
            //全选属性
            vm.allChecked = false;
            //日期选择器
            ...
            //打开叉车工作时间统计图表
            vm.openDriverWorkTimeCharts = openDriverWorkTimeCharts;
            //查询条件
            ...
            //打开叉车工作时间统计图表
            function openDriverWorkTimeCharts() {
                $state.go('module', { parent: 'reportCharts', name: 'driverWorkTimeCharts', param: null });
