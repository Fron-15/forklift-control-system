(function() {
    define(['app'], function(app) {
        app.controller('alarmReportCtrl', alarmReportCtrl);

        alarmReportCtrl.$inject = ['$scope', 'DatePicker', 'Service', '$state'];

        function alarmReportCtrl($scope, DatePicker, Service, $state) {
            var vm = this;
            //全选属性
            vm.allChecked = false;
            //日期选择器
            ...
            //打开月统计图表
            vm.openAlarmReportCharts = openAlarmReportCharts;
            //查询条件
            ...
            //打开叉车工作时间统计图表
            function openAlarmReportCharts() {
                $state.go('module', { parent: 'reportCharts', name: 'alarmReportCharts', param: null });
