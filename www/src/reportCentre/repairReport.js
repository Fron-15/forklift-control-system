...
(function() {
    define(['app'], function(app) {
        ...
        repairReportCtrl.$inject = ['$scope', 'DatePicker', 'Service', '$state'];

        function repairReportCtrl($scope, DatePicker, Service, $state) {
                        var vm = this;
            //全选属性
            vm.allChecked = false;
            //日期选择器
            ...
            //打开月统计图表
            vm.openrepairReportCharts = openrepairReportCharts;
            //查询条件
            ...
            //打开叉车工作时间统计图表
            function openrepairReportCharts() {
                $state.go('module', { parent: 'reportCharts', name: 'repairReportCharts', param: null });
